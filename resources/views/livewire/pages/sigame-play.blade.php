<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
    ...
    <div class="bg-white p-12 rounded shadow-sm border border-gray-100">
        @if($game->thumbnail_url)
            <img src="{{ Storage::url($game->thumbnail_url) }}" alt="{{ $game->title }}" class="w-32 h-32 object-cover rounded-full mx-auto mb-6 border-4 border-sigmaven-cream">
        @else
        ...
        <h1 class="text-4xl font-serif font-bold text-sigmaven-forest mb-4">{{ $game->title }}</h1>
        ...
        <div class="bg-green-50 border border-green-200 p-8 rounded-lg mb-8 max-w-lg mx-auto">
            ...
            <p class="text-green-700">Ini adalah halaman demo interaktif untuk game {{ $game->title }}. Pada versi rilis penuh, game akan termuat secara interaktif di area ini menggunakan HTML5 Canvas atau WebGL.</p>
        </div>
