                ...
                @auth
                    ...
                    <div x-data="{ dropdownOpen: false }" class="relative">
                        ...
                        <div x-show="dropdownOpen" @click.away="dropdownOpen = false" x-transition.opacity class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-dropdown py-1 border border-gray-100 z-50">
                            <a href="{{ route('account') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-80">My Account</a>
                            <a href="{{ route('wishlist') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-80">Wishlist</a>
