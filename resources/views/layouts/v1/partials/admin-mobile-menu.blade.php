<a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg transition hover:bg-white/10 {{ request()->routeIs('admin.dashboard') ? 'bg-white/20 font-semibold' : '' }}">
...
<a href="{{ route('admin.products') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg transition hover:bg-white/10 {{ request()->routeIs('admin.products') ? 'bg-white/20 font-semibold' : '' }}">
    <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
    Products
</a>
<a href="{{ route('admin.genres') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg transition hover:bg-white/10 {{ request()->routeIs('admin.genres') ? 'bg-white/20 font-semibold' : '' }}">
...
<a href="{{ route('admin.orders') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg transition hover:bg-white/10 {{ request()->routeIs('admin.orders') ? 'bg-white/20 font-semibold' : '' }}">
...
<a href="{{ route('admin.users') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg transition hover:bg-white/10 {{ request()->routeIs('admin.users') ? 'bg-white/20 font-semibold' : '' }}">
...
<a href="{{ route('admin.games') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg transition hover:bg-white/10 {{ request()->routeIs('admin.games') ? 'bg-white/20 font-semibold' : '' }}">
    <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z"></path></svg>
    Sigame
</a>
<a href="{{ route('admin.auctions') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg transition hover:bg-white/10 {{ request()->routeIs('admin.auctions') ? 'bg-white/20 font-semibold' : '' }}">
...
<a href="{{ route('admin.coupons') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg transition hover:bg-white/10 {{ request()->routeIs('admin.coupons') ? 'bg-white/20 font-semibold' : '' }}">
